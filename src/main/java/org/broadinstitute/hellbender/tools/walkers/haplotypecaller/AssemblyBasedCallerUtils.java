...
public final class AssemblyBasedCallerUtils {
    ...
    public static AssemblyResultSet assembleReads(final AssemblyRegion region,
        ...
        finalizeRegion(region, argumentCollection.errorCorrectReads, argumentCollection.dontUseSoftClippedBases, (byte)(argumentCollection.minBaseQualityScore - 1), header, sampleList, argumentCollection.correctOverlappingBaseQualities);
